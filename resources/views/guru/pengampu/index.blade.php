...
@section('title', 'List Pengampu')
@section('page-title', 'Input Data Pengampu')
@section('content')
...
<div class="row">
    <section class="content">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{action('Guru\PengampuController@destroy',$val->id)}}" id="hapus" ><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                                @else
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form method="POST" action="{{ route('pengampu.store') }}" enctype="multipart/form-data">
                           {{ csrf_field() }}
        ...
        <div class="modal fade" id="edit{{$val->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form method="POST" action="{{ route('pengampu.update',$val->id) }}" >
                    {{ csrf_field() }}
